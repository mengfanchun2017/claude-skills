...
当用户在 ccconfig 做实际工作时，fsysarchi 自动指出对应的考试知识点：
...
| 飞书集成（option-bridge, ffeishu） | 4. 企业信息化（企业应用集成） |
...
| 系统 | 关系 |
|------|------|
| fsearch | 学习模式的三源搜索委托 fsearch |
| ffeishu | 学习笔记输出到飞书文档 |
| flogme | 学习记录写入 Worklog 表（关联 OKR_KR "软考备考"）|
